...
# Force paging : should become set through options
// if(!isset($_GET['theFirstPage']) && !isset($_GET['p'])) {
// 	if(count($contents) > $pl) {
// 		header("Location: ?theFirstPage");
// 		httpStatusExit(303, 'See Other');
// 		exit;
// 	}
// }
